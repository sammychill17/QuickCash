...
public class RatingsActivityUITest {
    ...
    public void seeIfMyEmployeesButtonExists() throws UiObjectNotFoundException, InterruptedException {
        ...
        Thread.sleep(2000);
        assertTrue(device.findObject(new UiSelector().resourceIdMatches(".*meFragmentButton")).exists());
        assertFalse(device.findObject(new UiSelector().textContains("My Income Statistics")).exists());
    }
    ...
    public void seeIfMyRatingsButtonExists() throws UiObjectNotFoundException, InterruptedException {
        ...
        Thread.sleep(2000);
        assertTrue(device.findObject(new UiSelector().resourceIdMatches(".*meFragmentButton")).exists());
        assertTrue(device.findObject(new UiSelector().textContains("My Income Statistics")).exists());
    }
    ...
    public void seeIfMyEmployeesPageVisible() throws UiObjectNotFoundException, InterruptedException {
        ...
        assertTrue(device.findObject(new UiSelector().textContains("Pay")).exists());
    }
    ...
    public void seeIfRatePageVisible() throws UiObjectNotFoundException, InterruptedException {
        ...
        Thread.sleep(1000);
        assertTrue(device.findObject(new UiSelector().textContains("Submit Rating")).exists());
    }
}
